 ...
 */
public class ActEditShabaNO extends ActNewShabaNO {
    ...
    protected NumberManager getNumberManager() throws Exception {
        int _id = getIntent().getIntExtra(ID, -1);
        return new ShabaNO(this, _id, getPersonObj(), bank, getNum(), getDesc());
    }
